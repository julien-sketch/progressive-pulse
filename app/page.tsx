          ...
          <div className="rounded-2xl border border-slate-200/80 bg-white/88 backdrop-blur-md">
            <div className="flex items-center justify-between px-5 py-3">
              ...
              <div className="flex items-center gap-3">
                <a
                  href="/login"
                  className="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-extrabold text-slate-700 transition hover:bg-slate-50"
                >
                  Connexion
                </a>
                <a
